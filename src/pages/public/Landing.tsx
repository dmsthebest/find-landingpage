...
export function Landing() {
  return (
    <div className="-mx-4 -my-8 overflow-hidden">
      <section className="landing-grid paper-noise border-b border-paper-dark px-4 py-16 sm:py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><Link to="/painel" className="rounded bg-ink px-6 py-3.5 text-sm font-semibold text-paper transition-colors hover:bg-brass">Começar teste grátis →</Link><Link to="/barbearias" className="rounded border border-ink/25 bg-paper/70 px-6 py-3.5 text-sm font-semibold text-ink transition-colors hover:border-brass hover:text-brass">Encontrar uma barbearia</Link></div>
      ...
      <section className="bg-paper px-4 py-16 sm:py-24"><div className="mx-auto max-w-5xl"><div className="mb-10 max-w-xl"><p className="font-mono text-[10px] font-medium uppercase tracking-[0.16em] text-brass">Feito para os dois lados</p><h2 className="mt-3 font-display text-5xl leading-none text-ink sm:text-6xl">MENOS MENSAGENS.<br />MAIS CLIENTES.</h2></div><div className="grid gap-4 md:grid-cols-2"><article className="rounded-lg border border-paper-dark bg-white p-7 shadow-sm sm:p-9"><p className="font-mono text-xs text-brass">01 — CLIENTES</p><h3 className="mt-6 font-display text-4xl text-ink">MARQUE EM SEGUNDOS</h3><ul className="mt-5 space-y-3 text-sm text-ink-muted"><li>✓ Agendamento rápido e direto</li><li>✓ Sem precisar mandar mensagem</li><li>✓ Horários atualizados em tempo real</li></ul><Link to="/barbearias" className="mt-8 inline-block text-sm font-semibold text-brass hover:text-ink">Encontrar barbearias →</Link></article><article className="rounded-lg bg-ink p-7 text-paper shadow-sm sm:p-9"><p className="font-mono text-xs text-brass-light">02 — BARBEIROS</p><h3 className="mt-6 font-display text-4xl">AGENDA SOB CONTROLE</h3><ul className="mt-5 space-y-3 text-sm text-paper/70"><li>✓ Agenda organizada em um lugar</li><li>✓ Confirmações automáticas para clientes</li><li>✓ Controle de equipe e preços</li></ul><Link to="/painel" className="mt-8 inline-block text-sm font-semibold text-brass-light hover:text-paper">Testar para minha barbearia →</Link></article></div></div></section>
